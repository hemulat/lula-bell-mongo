...
def attach_images()
  file = File.open("/Users/anroybhattacharya/Desktop/Images/apple.jpg")
  @items = Item.all
  @items.each do |item|
    item.image = file
    item.save
...
def g_items(n=5)
  (1..n).each do |i|
    ...
    item = Item.create({name: na, rentable: rent, reservable: reserve,
                description: descr})
  end
end
...
def g_kitchen_items(n=5)
  (1..n).each do |i|
    ...
    item = Kitchen.create({name: na, rentable: rent, reservable: reserve,
                description: descr})
  end
end
...
def g_hygiene_items(n=5)
  (1..n).each do |i|
    ...
    rent = flip_a_coin
    reserve = rent ? flip_a_coin : false
    descr = "A Hygiene item - use it to keep yourself clean"
    item = Hygiene.create({name: na, rentable: rent, reservable: reserve,
                description: descr})
  end
end
...
def g_cleaning_items(n=5)
  (1..n).each do |i|
    ...
    item = Cleaning.create({name: na, rentable: rent, reservable: reserve,
                description: descr})
  end
end
...
def g_cooking_equipments(n=5)
  (1..n).each do |i|
    ...
    item = CookingEquipment.create({name: na, rentable: rent, reservable: reserve,
...
def g_food(n=5)
  (1..n).each do |i|
    ...
    item = Food.create({name: na, rentable: rent, reservable: reserve,
...
def g_clothing(n=5)
  (1..n).each do |i|
    ...
    item = Clothing.create({name: na, rentable: rent, reservable: reserve,
...
def g_school_supplies(n=5)
  (1..n).each do |i|
    ...
    item = SchoolSupply.create({name: na, rentable: rent, reservable: reserve,
                description: descr})
  end
end
...
def g_books(n=5)
  (1..n).each do |i|
    ...
    item = Book.create({name: na, rentable: rent, reservable: reserve,
